...
export default class CyServerPanel extends cc.Component {
    ...
    onLoad() {
        CyStateEngine.instance.node.on("getAvailableRooms", this.onGetRoomList, this);
        CyStateEngine.instance.node.on("roomJoined", this.onRoomJoined, this);
    }
    ...
    freshRoomList() {
        CyStateEngine.instance.getAvailableRooms();
    }

    leaveRoom() {
        CyStateEngine.instance.close();
    }
}
